---
layout: post
title: "25 March 2023 Catalog Update - Easy2Patch"
date: 2023-03-25
categories: [blog]
---
...
AmazonAmazon WorkSpaces 5.7.0

Anaconda Inc.Anaconda 3 2023.03

Bitwarden, Inc.Bitwarden Desktop 2023.3.0

Capture OneCapture One 23 16.1.2

Docker Inc.Docker Desktop 4.17.1

Don HoNotepad++ 8.5.1

DropboxDropbox 170.4.5895

GoogleGoogle Chrome 111.0.5563.111

Master Packager Ltd.MasterPackager 23.2.8474

MicrosoftAzure Data Studio 1.42.0 {System}

MicrosoftEdge WebView2 Runtime 111.0.1661.51

MicrosoftMicrosoft Edge 111.0.1661.51

OperaOpera 97.0.4719.28

OracleJava SE Development Kit 20.0.0

R-ProjectR for Windows 4.2.3

SlackSlack 4.31.152

SoftLanddoPDF 11.8.384

TeamViewerTeamViewer 15.40.8

TubitakAKIS Yonetici 6.5.1

VivaldiVivaldi 5.7.2921.65

WireGuardTailscale 1.38.2

Zoom Video CommunicationsZoom Desktop Client 5.14.0

Zoom Video CommunicationsZoom Outlook Plugin 5.14.0
...
> More Info: [https://akiskart.bilgem.tubitak.gov.tr/akis-nedir](https://akiskart.bilgem.tubitak.gov.tr/akis-nedir)
> Support Info: [https://akiskart.bilgem.tubitak.gov.tr/destek](https://akiskart.bilgem.tubitak.gov.tr/destek)
> Dikkat! Bu paket upgrade paketi değildir. Uretici tarafından yeni bir sürüm olarak yayinlanmistir. Dolayısı ile onceki surumu tespit etmeyebilir ve/veya uzerine kurulum yapmayabilir. Yeni bir kurulum gibi degerlendirilmistir. ------- Attention! This package is not an upgrade package. Released as a new version by the manufacturer. Therefore, it may not detect and/or install on the previous version. It is considered as a new installation.
...
> More Info: [https://docs.anaconda.com/anaconda/reference/release-notes/](https://docs.anaconda.com/anaconda/reference/release-notes/)
> Support Info: [https://anaconda.cloud/support-center](https://anaconda.cloud/support-center)
...
> More Info: [https://support.captureone.com/hc/en-us/articles/9985554350365-Capture-One-23-16-1-2-release-notes](https://support.captureone.com/hc/en-us/articles/9985554350365-Capture-One-23-16-1-2-release-notes)
...
> More Info: [https://www.dropboxforum.com/t5/Dropbox-desktop-client-builds/Stable-Build-170-4-5895/td-p/669962](https://www.dropboxforum.com/t5/Dropbox-desktop-client-builds/Stable-Build-170-4-5895/td-p/669962)
...
> More Info: [https://chromereleases.googleblog.com/2023/03/stable-channel-update-for-desktop_21.html](https://chromereleases.googleblog.com/2023/03/stable-channel-update-for-desktop_21.html)
...
> More Info: [https://www.oracle.com/java/technologies/javase/20all-relnotes.html](https://www.oracle.com/java/technologies/javase/20all-relnotes.html)
...
> More Info: [https://notepad-plus-plus.org/downloads/v8.5.1/](https://notepad-plus-plus.org/downloads/v8.5.1/)
...
> More Info: [https://blogs.opera.com/desktop/2023/03/opera-97-0-4719-28-stable-update/](https://blogs.opera.com/desktop/2023/03/opera-97-0-4719-28-stable-update/)
...
> More Info: [https://cran.r-project.org/doc/manuals/r-release/NEWS.html](https://cran.r-project.org/doc/manuals/r-release/NEWS.html)
> Support Info: [https://cran.r-project.org/index.html](https://cran.r-project.org/index.html)
> [R logo] CHANGES IN R 4.2.3 C-LEVEL FACILITIES The definition of DL\_FUNC in ‘R\_ext/Rdynload.h’ has been changed to be fully C-compliant. This means that functions loaded via for example R\_GetCCallable need to be cast to an appropriate type if they have any arguments. .Machine has a new element sizeof.time\_t to identify old systems with a 32-bit type and hence a limited range of date-times (and limited support for dates millions of years from present). PACKAGE INSTALLATION (Windows) The default C++ standard had accidentally been left at C++11 when it was changed to C++14 on Unix. BUG FIXES As "POSIXlt" objects may be “partially filled” and their list components meant to be recycled, length() now is the length of the longest component.
...
> More Info: [https://community.teamviewer.com/English/discussion/128752/windows-v15-40-8](https://community.teamviewer.com/English/discussion/128752/windows-v15-40-8)
...
> More Info: [https://vivaldi.com/blog/desktop/minor-update-three-5-7/](https://vivaldi.com/blog/desktop/minor-update-three-5-7/)
...
> Support Info: [https://support.zoom.us/hc/en-us](https://support.zoom.us/hc/en-us)
> Current Release February 27, 2023 version 5.13.10.810 (Windows) Resolved issues Minor bug fixes Resolved an issue where licensed users received a 40-minute time limit on meetings with Zoom Outlook plugin. Previous Releases Note: The information in the past release notes may have been superseded by subsequent release notes. Please review all current release notes carefully.

[PreviousEasy2Patch April 1 Catalog Update #20230401](/catalog-posts/easy2patch-april-1-catalog-update-20230401)[NextEasy2Patch March 18 Catalog Update #20230318](/catalog-posts/easy2patch-march-18-catalog-update-20230318)
Last updated <time data-visual-test="transparent" datetime="2023-05-07T18:13:03.000Z" data-state="closed">2 years ago</time>
